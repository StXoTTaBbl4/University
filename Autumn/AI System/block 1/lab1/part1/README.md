## Алярм. 
Чтобы пролог работал с символами из великого и могучего алфавита нужно в swi-prolog перейти в `settings` -> `user init file`, где прописать `:- set_prolog_flag(encoding, utf8).`
Ну или создать руками файл init.pl в ..\%appdata%\Roaming\swi-prolog и прописать там ту же строчку.  
