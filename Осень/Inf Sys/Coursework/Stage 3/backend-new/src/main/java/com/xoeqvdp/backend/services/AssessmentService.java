...
import com.xoeqvdp.backend.repositories.*;
...
public class AssessmentService {
    ...
    public void saveAssessment(List<AssessmentItemDTO> hw, List<AssessmentItemDTO> sw, List<AssessmentItemDTO> pr, String accessToken) {
        Employee employee = employeeRepository.findByEmail(jwtService.extractUsername(accessToken)).orElseThrow(()-> new IllegalArgumentException("Пользователь не найден. Попробуйте выполнить вход заново."));
    ...
    private void saveSkills(List<AssessmentItemDTO> items, Employee employee){
